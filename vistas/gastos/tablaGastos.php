        ...
        <tr>
            ...
            <td class="text-center">
                <button class="btn btn-warning btn-sm">
                    <span class="fas fa-edit"  data-toggle="modal" data-target="#modalActualizar" onclick="obtenerDatos(<?php echo $idGasto ?>)"></span>
                </button>
            </td>
            <td class="text-center">
                <button class="btn btn-danger btn-sm">
                <span class="fas fa-dumpster-fire" onclick="eliminarGastos('<?php echo $idGasto?>')"></span>
                </button>
            </td>
        </tr>
        <?php
